...
with col_int_left:
    st.subheader("🎯 Mock Interview Radar")
    if not interviews:
...
with col_int_right:
    ...
    if not interviews:
        st.info("No mock interview attempts recorded yet. Head to the Learning Roadmap page to practice interview questions.")
    else:
        rows_html = ""
        for item in interviews[:5]:
            ...
            rows_html += f"""
            <tr>
                <td style="padding:10px; border-bottom:1px solid rgba(255,255,255,0.06); color:#F8FAFC;">{dt_str}</td>
        ...
        <table style="width:100%; border-collapse:collapse; margin-top:10px;">
            <thead>
                <tr style="background:rgba(255,255,255,0.03); text-align:left;">
                    <th style="padding:10px; border-bottom:1px solid rgba(255,255,255,0.1); color:#818CF8;">Session Date</th>
                    <th style="padding:10px; border-bottom:1px solid rgba(255,255,255,0.1); color:#818CF8; text-align:center;">Score</th>
